...
<head>
    ...
    <link href="public/source/assets/dest/fonts/Linearicons-Free-v1.0.0/icon-font.min.css" rel="stylesheet"
          type="text/css">
...
<div id="back-to-top" title="Back to top">
    <span class="symbol-btn-back-to-top"><i class="fa fa-angle-up" aria-hidden="true"></i></span>
</div>
@include('footer')
